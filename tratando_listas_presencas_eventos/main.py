...
Util.mostrar_lista(lista_inscritos)

lista_terca_manha.sort()
Util.mostrar_lista(lista_terca_manha)

lista_terca_noite.sort()
Util.mostrar_lista(lista_terca_noite)

lista_quarta_manha.sort()
Util.mostrar_lista(lista_quarta_manha)

lista_quarta_noite.sort()
Util.mostrar_lista(lista_quarta_noite)
...
# 7. Mostra os que não terao atestado


print("Sem atestado: ", len(lista_nao_atestado))
for aluno in lista_nao_atestado:
    print(aluno)